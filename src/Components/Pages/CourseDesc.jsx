            ...
            <div className="h-[92vh] bg-slate-600 flex items-center justify-center">
                <div className="flex  shadow-[0_0_10px_black] w-[30rem] rounded-md">
                    <div className="w-1/2 flex flex-col">
                        <img src={developer} alt="thumbnail" className="h-28 w-full rounded-sm" />
                        <div className="pl-4 pb-4 mt-2">
                            <p className="font-medium text-white">Total lectures : <span
                                className="text-yellow-500 text-lg">{data.numbersOflectures || 0} </span>
                            </p>
                    ...
                    <div className="flex flex-col gap-2 w-1/2 p-3">
                        ...
                        <button className="w-full mt-4 font-bold hover:bg-yellow-400 transition-all ease-in-out duration-300 bg-yellow-500 text-white py-2 rounded-md">Subscribe</button>
                    </div>
